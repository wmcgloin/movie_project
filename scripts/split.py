...
cast_and_crew = pd.read_csv('../data/clean_data/cast_and_crew.csv')
...
first_half.to_csv('../data/clean_data/cast_and_crew1.csv', index=False)
second_half.to_csv('../data/clean_data/cast_and_crew2.csv', index=False)